...
type ActionCallLog struct {
	...
	Arguments    map[string]any `bson:"arguments,omitempty" json:"arguments,omitempty"`
...
type IterationLog struct {
	...
	OracleResponse   string          `bson:"oracle_response" json:"oracle_response"`
	ActionCalls      []ActionCallLog `bson:"action_calls,omitempty" json:"action_calls,omitempty"`
	BannedActions    []string        `bson:"banned_actions,omitempty" json:"banned_actions,omitempty"`
	ReflectionIssues []string        `bson:"reflection_issues,omitempty" json:"reflection_issues,omitempty"`
...
type InteractionTokenUsage struct {
	Reasoning TokenUsageBreakdown `bson:"reasoning" json:"reasoning"`
	Media     TokenUsageBreakdown `bson:"media" json:"media"`
	Total     TokenUsageBreakdown `bson:"total" json:"total"`
}
...
type InteractionEventLog struct {
	...
	Attachments    []AttachmentLog `bson:"attachments,omitempty" json:"attachments,omitempty"`
	Knowledge      map[string]any  `bson:"knowledge,omitempty" json:"knowledge,omitempty"`
	ScoutsUsed     []string        `bson:"scouts_used,omitempty" json:"scouts_used,omitempty"`
...
type InteractionProcessingLog struct {
	Status           string `bson:"status" json:"status"` // "success" | "rate_limited" | "validation_failed" | ...
	ProcessingTimeMs int64  `bson:"processing_time_ms" json:"processing_time_ms"`

	PipelineFailedAtStep string `bson:"pipeline_failed_at_step,omitempty" json:"pipeline_failed_at_step,omitempty"`
	PathfinderUsed       string `bson:"pathfinder_used,omitempty" json:"pathfinder_used,omitempty"`
	ArchivistApplied     bool   `bson:"archivist_applied,omitempty" json:"archivist_applied,omitempty"`

	SessionMessagesCount   int `bson:"session_messages_count" json:"session_messages_count"`
	CoalescedMessagesCount int `bson:"coalesced_messages_count,omitempty" json:"coalesced_messages_count,omitempty"`

	Iterations      []IterationLog `bson:"iterations" json:"iterations"`
	IterationsUsed  int            `bson:"iterations_used" json:"iterations_used"`
	...
	ExecutionErrors []string       `bson:"execution_errors,omitempty" json:"execution_errors,omitempty"`

	ResponseDelivered bool   `bson:"response_delivered" json:"response_delivered"`
	ResponseChannel   string `bson:"response_channel,omitempty" json:"response_channel,omitempty"`
}
...
type Chronicle struct {
	...
	Event      InteractionEventLog      `bson:"event" json:"event"`
	Spirit     InteractionSpiritLog     `bson:"spirit" json:"spirit"`
	Processing InteractionProcessingLog `bson:"processing" json:"processing"`
	TokenUsage InteractionTokenUsage    `bson:"token_usage" json:"token_usage"`
