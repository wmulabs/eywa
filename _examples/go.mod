...
require (
	...
	github.com/wmulabs/eywa/fiber v1.5.0
	github.com/wmulabs/eywa/mcp v1.5.0
	github.com/wmulabs/eywa/mongo v1.5.0
	github.com/wmulabs/eywa/providers/openai v1.5.0
	github.com/wmulabs/eywa/redis v1.5.0
)
